...
local loadstring, getgenv, setclipboard, tablefind, UserInputService, GuiService, RunService = loadstring, getgenv, setclipboard, table.find, game:GetService("UserInputService"), game:GetService("GuiService"), game:GetService("RunService")
...
if IS_MOBILE then
    ...
    aimButton.Position = UDim2.new(1, -100, 1, -100)
    aimButton.BackgroundColor3 = Color3.fromRGB(0, 120, 215)
    aimButton.BackgroundTransparency = 0.3
    aimButton.TextColor3 = Color3.fromRGB(255, 255, 255)
    aimButton.Text = "AIM"
    aimButton.TextSize = 14
    aimButton.ZIndex = 1000
    aimButton.Parent = mobileControls
    
    -- Toggle button
    local toggleButton = Instance.new("TextButton")
    toggleButton.Name = "ToggleButton"
    toggleButton.Size = UDim2.new(0, 80, 0, 80)
    toggleButton.Position = UDim2.new(1, -100, 1, -190)
    ...
    local function setupMobileControls()
        mobileControls.Parent = game:GetService("CoreGui") or game.Players.LocalPlayer:WaitForChild("PlayerGui")
        
        -- Aim button functionality
        aimButton.MouseButton1Down:Connect(function()
            Aimbot.Settings.TriggerKey = "MobileAim"
        end)
        
        aimButton.MouseButton1Up:Connect(function()
            Aimbot.Settings.TriggerKey = "None"
        end)
        ...
        toggleButton.MouseButton1Click:Connect(function()
            ...
            Aimbot.Settings.Enabled = toggleState
            if toggleState then
                toggleButton.BackgroundColor3 = Color3.fromRGB(0, 215, 0)
    ...
    -- Setup mobile controls when player is ready
...
Values:AddToggle({
	...
	Callback = function(New, Old)
        ...
        if IS_MOBILE then
            local toggleButton = game:GetService("CoreGui"):FindFirstChild("MobileControls") and game:GetService("CoreGui").MobileControls:FindFirstChild("ToggleButton")
