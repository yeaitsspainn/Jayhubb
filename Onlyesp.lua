...
local Config = {
    ["TheBronx"] = {
        ...
        ["TeleportationList"] = {
            ["Hospital ð¥"] = CFrame.new(-1589.49805, 254.669968, 15.838623, 1, 0, 0, 0, 1, 0, 0, 0, 1);
            ["Deli Market ð¥ª"] = CFrame.new(-602.3944091796875, 253.73313903808594, -584.2000732421875);
            ["Capital One Bank ð¦"] = CFrame.new(-205, 284, -1214);
            ["Ice Box ð§"] = CFrame.new(-198.8927001953125, 283.8486633300781, -1170.4500732421875);
            ["Domino's ð"] = CFrame.new(-742.5213012695312, 253.22897338867188, -946.2092895507812);
            ["Hotel ð¨"] = CFrame.new(-1012, 266, -933);
            ["Drip Store ð"] = CFrame.new(67462.6953125, 10489.0322265625, 546.6762084960938);
            ["Gun Shop ð«"] = CFrame.new(93006, 122100, 17307);
            ["Car Dealer ð"] = CFrame.new(-378.6668701171875, 253.2564697265625, -1245.4259033203125);
            ...
            ["Basketball Court ð"] = CFrame.new(-1055.6407470703125, 253.51364135742188, -497.10528564453125);
            ["Robbable Ice Box ð§"] = CFrame.new(-209.68360900878906, 283.4959411621094, -1265.5286865234375);
            ["Exotic Dealer / Grass House ð"] = CFrame.new(-1521.943115234375, 272.5462646484375, -984.3020629882812);
            ["Safe ð"] = CFrame.new(-190, 295, -1010);
            ["Roof Top / Bank Tools ð "] = CFrame.new(-385, 340, -557);
    ...
    ["Road_To_Riches"] = {
        ...
        ["Locations"] = {
            ...
            ["Gold Shop ðª"] = CFrame.new(-78.1158218383789, 2563.1123046875, 944.74365234375);
            ...
            ["Gym ðª" ] = CFrame.new(-37.920719146728516, 2563.05029296875, 442.32647705078125);
            ...
            ["Scrap Metal âï¸"] = CFrame.new(1049, 2563, 1052);
        };
        ...
        VulnerabilitySection:Button({
            ...
            callback = function()
                ...
                if Cup and Found then
                    HideUI("generating illegal cash ð·\n please wait.")
                    local OLDCFrame = LocalPlayer.Character.HumanoidRootPart.CFrame
