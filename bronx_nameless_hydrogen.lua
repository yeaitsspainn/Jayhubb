...
-- // Nameless Hub | Hydrogen-style UI (mobile friendly, draggable, open/close) for The Bronx
...
do
    ...
    -- // ScreenGui + Floating Open Button (Hydrogen style pill)

    local MasterGui = Instance.new("ScreenGui")
    MasterGui.Name = "NamelessHub_HydrogenStyle"
    ...
    OpenButton.Position = UDim2.new(0, 20, 0.7, 0)
    OpenButton.BackgroundColor3 = Color3.fromRGB(40, 40, 55)
    OpenButton.BorderSizePixel = 0
    OpenButton.AutoButtonColor = true
    OpenButton.Font = Enum.Font.GothamBold
    OpenButton.Text = "⛭  Nameless Hub"
    ...
    -- // Main Window (Hydrogen style: rounded, large, mobile-friendly)
    ...
    Title.Text = "Nameless Hub   |   The Bronx 3"
    Title.TextSize = 17
    ...
    Subtitle.Position = UDim2.new(0, 16, 0, 18)
    Subtitle.Font = Enum.Font.Gotham
    Subtitle.TextXAlignment = Enum.TextXAlignment.Left
    Subtitle.Text = "Hydrogen-style control panel"
    ...
    -- Left tab navigation (bigger buttons, mobile friendly)

    local TabsFrame = Instance.new("Frame")
    TabsFrame.Name = "Tabs"
    TabsFrame.Size = UDim2.new(0, 170, 1, -42)
    ...
    TabsHolder.Size = UDim2.new(1, -16, 1, -20)
    TabsHolder.Position = UDim2.new(0, 8, 0, 10)
    TabsHolder.BackgroundColor3 = Color3.fromRGB(20, 20, 28)
    ...
    local TabsPadding = Instance.new("UIPadding", TabsHolder)
    ...
    ContentFrame.Size = UDim2.new(1, -190, 1, -52)
    ContentFrame.Position = UDim2.new(0, 182, 0, 50)
        ...
        TabButton.MouseButton1Click:Connect(function()
            ...
            for _, child in ipairs(TabsHolder:GetChildren()) do
                if child:IsA("TextButton") then
                    child.BackgroundColor3 = Color3.fromRGB(26, 26, 34)
                end
            end
    ...
    GameLabel.Size = UDim2.new(1, -4, 0, 22)
    GameLabel.Font = Enum.Font.Gotham
    GameLabel.TextXAlignment = Enum.TextXAlignment.Left
    GameLabel.Text = "bronx.lol | Nameless Hub | Hydrogen Styled"
    GameLabel.TextSize = 13
    GameLabel.TextColor3 = Color3.fromRGB(210, 210, 230)
    GameLabel.ZIndex = 4
