...
if LPH_OBFUSCATED == nil then
    ...
    LRM_ScriptName = "Nameless Hub.ez"
...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("Nameless Hub.ez | Security : You are running another script, please disable it and execute again")
    end
end
...
getgenv().library = {
    directory = "Nameless Hub.ez_remastered",
    folders = {
        "/fonts",
        "/configs",
        "/assets"
    ...
    LPH_JIT_MAX(function()
            ...
            RunService:BindToRenderStep("MiscSettings", 1000 , LPH_NO_VIRTUALIZE(function(Delta)
                ...
                if not (Game_Name == "South Bronx") and not (Game_Name == "Road To Riches") then
                    if Config.MiscSettings.ModifySpeed.Enabled then
                        ...
                        if UserInputService.TouchEnabled and LocalPlayer.Character and LocalPlayer.Character:FindFirstChildOfClass("Humanoid") then
                            Direction = LocalPlayer.Character:FindFirstChildOfClass("Humanoid").MoveDirection
                        else
        ...
        if Game_Name == "South Bronx" then
            ...
            ShootPlayer = LPH_NO_VIRTUALIZE(function(Player)
                ...
                if not LocalPlayer.Character:FindFirstChildOfClass("Tool") or game.Players.LocalPlayer.Backpack:FindFirstChildOfClass("Tool") then
                    return
                end
            ...
            local items = cfg.items; do 
                -- Component
                    items[ "colorpicker" ] = library:create( "TextButton" , {
                        ...
                        BorderSizePixel = 0;
                        TextSize = 14;
                        BackgroundColor3 = rgb(44, 90, 200)
                    });
...
local window = library:window({name = "bronx", suffix = ".lol", gameInfo = string.format("Nameless Hub.ez : %s", Game_Name:lower())})
