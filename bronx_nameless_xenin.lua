...
-- \\ Script
-- Xenin-style UI rewrite for Nameless Hub (Delta compatible)
...
local TheBronxConfig = Config.TheBronx
...
local function safecall(fn, ...)
    if typeof(fn) == "function" then
        ...
        if not ok then
            warn("[Nameless Hub] callback error:", err)
        end
    end
end

-- // basic Xenin-style window

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "NamelessHub_Xenin"
...
MainFrame.BackgroundColor3 = Color3.fromRGB(35, 30, 55) -- dark lavender base
...
TopBar.BackgroundColor3 = Color3.fromRGB(120, 90, 180) -- lavender
...
LockButton.MouseButton1Click:Connect(function()
    ...
    for _, child in ipairs(MainFrame:GetChildren()) do
        if child ~= TopBar and child:IsA("Frame") then
            child.Visible = not collapsed
        end
    end
    MainFrame.Size = collapsed and UDim2.new(0, 200, 0, 40) or UDim2.new(0, 450, 0, 280)
end)
...
TabsFrame.Name = "Tabs"
TabsFrame.Size = UDim2.new(0, 100, 1, -32)
...
local currentPage
local function selectTab(pageButton, pageFrame)
    if currentPage then
    ...
    for _, child in ipairs(TabsFrame:GetChildren()) do
        if child:IsA("TextButton") then
            child.BackgroundColor3 = Color3.fromRGB(45, 35, 70)
        end
    end
    pageButton.BackgroundColor3 = Color3.fromRGB(120, 90, 180)
end
...
local function createNumberBox(parent, text, default, callback)
    local holder = Instance.new("Frame")
    holder.Name = text .. "_Holder"
    holder.Size = UDim2.new(1, -12, 0, 24)
    ...
    box.BackgroundColor3 = Color3.fromRGB(45, 35, 70)
...
-- // Tabs
local CombatButton, CombatPage = createTab("Combat")
local VisualsButton, VisualsPage = createTab("Visuals")
local MiscButton, MiscPage = createTab("Misc")
local TeleportButton, TeleportPage = createTab("Teleports")

CombatButton.MouseButton1Click:Connect(function()
    selectTab(CombatButton, CombatPage)
end)
VisualsButton.MouseButton1Click:Connect(function()
    selectTab(VisualsButton, VisualsPage)
end)
MiscButton.MouseButton1Click:Connect(function()
    selectTab(MiscButton, MiscPage)
end)
TeleportButton.MouseButton1Click:Connect(function()
    selectTab(TeleportButton, TeleportPage)
end)
...
createToggle(CombatPage, "Aimlock Enabled", Aimlock.Enabled or false, function(v)
    Aimlock.Enabled = v
    Config.Aimlock = Aimlock
end)

createNumberBox(CombatPage, "Aimlock FOV", Aimlock.Radius or 100, function(v)
    Aimlock.Radius = v
    Config.Aimlock = Aimlock
end)

createToggle(CombatPage, "Silent Aim Enabled", Silent.Enabled or false, function(v)
    Silent.Enabled = v
    Config.Silent = Silent
end)

createNumberBox(CombatPage, "Silent Aim FOV", Silent.Radius or 100, function(v)
    Silent.Radius = v
    Config.Silent = Silent
end)
...
createToggle(VisualsPage, "ESP Enabled", ESP.Enabled or false, function(v)
    ESP.Enabled = v
    Config.ESP = ESP
    safecall(RefreshAllElements)
end)

createToggle(VisualsPage, "Fullbright", WorldVisuals.Fullbright or false, function(v)
    WorldVisuals.Fullbright = v
    Config.WorldVisuals = WorldVisuals
end)

createToggle(VisualsPage, "Custom FOV", WorldVisuals.FieldOfViewEnabled or false, function(v)
    WorldVisuals.FieldOfViewEnabled = v
    Config.WorldVisuals = WorldVisuals
end)

createNumberBox(VisualsPage, "FOV Value", WorldVisuals.FieldOfViewValue or 70, function(v)
...
createToggle(MiscPage, "Modify WalkSpeed", MiscSettings.ModifySpeed.Enabled, function(v)
    MiscSettings.ModifySpeed.Enabled = v
    Config.MiscSettings = MiscSettings
end)

createNumberBox(MiscPage, "WalkSpeed %", MiscSettings.ModifySpeed.Value or 50, function(v)
    MiscSettings.ModifySpeed.Value = v
    Config.MiscSettings = MiscSettings
end)

createToggle(MiscPage, "Modify Jump", MiscSettings.ModifyJump.Enabled, function(v)
    MiscSettings.ModifyJump.Enabled = v
    Config.MiscSettings = MiscSettings
end)

createNumberBox(MiscPage, "Jump Power", MiscSettings.ModifyJump.Value or 50, function(v)
...
if TheBronxConfig.TeleportationList then
    for name, _ in pairs(TheBronxConfig.TeleportationList) do
...
for _, name in ipairs(teleportOptions) do
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        local cf = TheBronxConfig.TeleportationList and TheBronxConfig.TeleportationList[name]
        if hrp and cf then
            hrp.CFrame = cf
            TheBronxConfig.Selected_Location = name
            Config.TheBronx = TheBronxConfig
        end
    end)
end
